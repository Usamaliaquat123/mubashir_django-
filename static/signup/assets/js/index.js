...
const signUpFormCheck = document.getElementById('signUpFormCheck')
const signUpBtn = document.getElementById('signUpBtn');



let isSignInActive = true;
const defaultPageIsSignIn = false
...
signUpFormCheck.addEventListener('click', function() {
    if (signUpFormCheck.checked == true) {
